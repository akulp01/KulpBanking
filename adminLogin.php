...
<body>
    ...
    <form id="first" action="adminLogin-submit.php" method="POST" enctype="multipart/form-data">
        <h3>Kulp Banking</h3>
        <h4>Admin Login</h4>
    ...
    <form id="third" action="index.php" method="POST">
        <input id="clientbutton" type="submit" class="button" value="Log In As Client" />
    </form>
